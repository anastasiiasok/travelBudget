...
// const sendReportBtn = document.querySelector('#registration')
...
//     from: '"Fred Foo 👻" <test2020test2020abc@yandex.ru>', // sender address
//     to: "test2020test2020abc@yandex.ru", // list of receivers
